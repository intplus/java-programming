...
/*
A simple maze generator, using depth-first search. The w and h values are for width and height and represent
the INNER MAZE WIDTH. Meaning the open spaces on the inside of the maze. For example,
a 4x4 maze will look something like this (actually a 9x9 boolean array):
#########
# #   # #
# ### # #
#   # # #
