...
public class RadioButtonDemo extends JPanel
    ...
    static String birdString = "tiger_up";
    static String catString = "bt7_up";
    static String dogString = "tiger_left";
    static String rabbitString = "bt7_down";
    static String pigString = "tiger_down";
    ...
    public RadioButtonDemo() {
        ...
        picture = new JLabel(createImageIcon(birdString
                + ".png"));
