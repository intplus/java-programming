...
public class Goods {
    ...
    private ArrayList<Product> productsHikvision = new ArrayList<Product>();
    private ArrayList<Product> productsActiveCam = new ArrayList<Product>();
    private ArrayList<Product> productsServers = new ArrayList<Product>();
